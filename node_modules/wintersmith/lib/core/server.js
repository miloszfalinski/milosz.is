              ...
              if (error) {
                ...
                if (result instanceof Stream) {
                  response.writeHead(200, {
                    'Content-Type': mime.lookup(content.filename)
                  });
                  ...
                  return callback(new Error("View for content '" + res.filename + "' returned invalid response. Expected Buffer or Stream."));
                }
              } else {
                return callback();
              }
