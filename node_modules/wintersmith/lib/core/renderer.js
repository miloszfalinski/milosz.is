...
(function() {
  var ContentTree, Stream, async, fs, mkdirp, path, pump, render, renderView, setImmediate, util;
  ...
  renderView = function(env, content, locals, contents, templates, callback) {
    return setImmediate(function() {
      ...
      return view.call(content, env, locals, contents, templates, function(error, result) {
        if (error != null) {
